...
export async function runWeeklyReview(
  ...
  const prompt = [
    ...
    "the imperative (e.g. '- Cut one grey-zone ride', '- Move the long run off your GI-trough day') — these",
    "are surfaced verbatim on the dashboard, so keep each a single actionable line. Be concise and cite the data.",
