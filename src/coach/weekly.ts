...
export async function runWeeklyReview(
  ...
  const prompt = [
    ...
    "TREND (not single points). END with a '## Next week' section: 2–4 short, specific bullet actions in",
    "the imperative — these are surfaced verbatim as in-app cards the athlete acts on, so keep each a single",
    "self-contained actionable line. Each should be doable: a training PLAN edit phrased as a clear edit",
    "(e.g. '- Cut one grey-zone ride', '- Move the long run off your GI-trough day'), or a fuelling, gear or",
    "recovery change where the data warrants one (e.g. '- Take 60 g/h carb on rides over 90 min'). Don't point",
    "at this report or say 'discuss with your coach' — state the action itself. Be concise and cite the data.",
