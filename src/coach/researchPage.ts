...
<style>body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;max-width:760px;margin:0 auto;padding:26px 20px 64px;color:#2b2b2b;line-height:1.6}h1{font-size:22px;margin:.3em 0 .35em}h2{font-size:18px;margin:1.1em 0 .3em}h3{font-size:15px;margin:1em 0 .2em}a{color:#c8642d}code{background:#f4f1ea;border-radius:4px;padding:1px 5px;font-size:.92em}i,em{font-style:italic}.back{display:inline-block;margin-bottom:18px;font-size:13px;text-decoration:none}.digest{font-size:15px}.digest p{margin:.5em 0}.digest ul,.digest ol{margin:.3em 0 .85em;padding-left:1.45em}.digest li{margin:.25em 0}.digest hr{border:none;border-top:1px solid #e7d9c6;margin:1.5em 0}.digest blockquote{margin:.5em 0;padding:.35em .95em;border-left:3px solid #d9cdb8;background:#faf8f3;border-radius:0 5px 5px 0;color:#555;font-style:italic}.note{background:#faf8f3;border-left:3px solid #e7d9c6;border-radius:5px;padding:12px 14px;font-size:14px;margin:0 0 20px}</style></head>
