...
| `fuelling.current_sources` | What products/sources do you currently fuel with? | Recorded for your reference and visible via get_profile; not yet read by an automated flow. |
